...
class QueryBackup
{
     ...
     * @param string $path
     */
    public function __construct($path = __DIR__ . '/../Resources/config/querybuilderdb.sqlite')
    {
        $user        = Yaml::parse(file_get_contents(__DIR__ . '/../Resources/config/config.yml'))['user'];
        $association = Yaml::parse(file_get_contents(__DIR__ . '/../Resources/config/config.yml'))['association'];
