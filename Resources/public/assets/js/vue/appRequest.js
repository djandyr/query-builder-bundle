...
request = new Vue({
    ...
    methods: {
        search: function () {
            ...
            this.$http.post('/querybuilder/query', {action_query_builder: 'execute_query_json', json_query: $jsonQuery}).then(
                response => {
                    this.loading = false;
        ...
        spreadsheet: function () {
            this.$http.post('/querybuilder/query', {action_query_builder: 'spreadsheet', columns: this.columns, data: this.data}).then(
                response => {
        ...
        save: function ($isPrivate = 0) {
            ...
            this.query.limit = this.limit;
            this.query.offset = this.offset;
            this.$http.post('/querybuilder/query', {
        ...
        loadSave: function ($id) {
            this.loading = true;
            this.$http.post('/querybuilder/query', {action_query_builder: 'load_query', query_id: $id}).then(
                response => {
                    this.loading = false;
        ...
        deleteSave: function ($id, $index) {
            this.loading = true;
            this.$http.post('/querybuilder/query', {action_query_builder: 'delete_query', query_id: $id}).then(
                response => {
        ...
        getListQuery: function () {
            this.loading = true;
            this.$http.post('/querybuilder/query', {action_query_builder: 'get_list_query'}).then(
                response => {
                    this.showModal = false;
                    this.loading = false;
        ...
        _getDbObject: function (callback) {
            this.$http.post('/querybuilder/query', {action_query_builder: 'get_db_object'}).then(
                response => {
        ...
        _getDbTitle: function () {
            this.$http.post('/querybuilder/query', {action_query_builder: 'get_db_title'}).then(
                response => {
